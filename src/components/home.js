    ...
    <>
      ...
      >
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)" }}>
          ...
          <div className="partright"></div>
        </div>

        <div style={{width:'100%',}} className="flex gap-10 mt-10 justify-around">
          <div style={{width:"100px",}} className="flex text-sm items-center gap-1">
